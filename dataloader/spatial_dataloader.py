...
class spatial_dataset(Dataset):  
    ...
    def load_ucf_image(self,video_name, index):
        if video_name.split('_')[0] == 'HandstandPushups':
            ...
            path = self.root_dir +'/v_'+name+'/frame00'
...
class spatial_dataloader():
    ...
    def load_frame_count(self):
        ...
        with open('/nfs/syzhou/github/two-stream-action-recognition/dataloader/dic/frame_count.pickle','rb') as file:
